...
public class ScheduledNotificationDispatchTaskTest extends PersistenceCapableTest {
    ...
    public void shouldDispatchNewVulnNotification() {
        ...
        rule.setScheduleLastFiredAt(Date.from(ruleLastFiredAt));
        ...
        assertThat(rule.getScheduleLastFiredAt()).isAfter(ruleLastFiredAt);
        assertThat(rule.getScheduleNextDueAt()).isInTheFuture();
    }
